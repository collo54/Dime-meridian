...
//   // Use FirebaseAuth.instance directly. It's a singleton and safe to use.
//   // This avoids waiting for another provider to initialize.
...
// final userProvider = StreamProvider<UserModel?>((ref) {
//   // Use authStateChanges, it is more stable for session persistence than idTokenChanges
//   return ref.watch(authenticate).onAuthStateChanged;
// });
